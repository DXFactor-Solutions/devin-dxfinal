...
const AIColleagueShowcase = () => {
  ...
  return (
    <section id="assistants" className="w-full min-h-screen bg-gray-950 text-white overflow-hidden flex flex-col relative">
      ...
      <button
        className="absolute top-1/2 left-6 z-50 -translate-y-1/2 hover:scale-110 p-2 transition-all"
      ...
      <button
        className="absolute top-1/2 right-6 z-50 -translate-y-1/2 hover:scale-110 p-2 transition-all"
