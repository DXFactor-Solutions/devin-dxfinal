...
const AgentsSection: React.FC = () => {
  ...
  return (
    <section className="py-8 sm:py-12 bg-white" id="agents">
            ...
            <div className="relative z-10 mb-4 sm:mb-6">
              <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-3 sm:mb-4 leading-tight">
                ...
                <span className="relative">
                  ...
                  <div className="absolute -bottom-1 sm:-bottom-2 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-green-600 to-emerald-500 rounded-full"></div>
                </span>
                <br />
                Agent Platform
              </h2>
              ...
              >
                <div className="flip-card-inner h-full">
                  ...
                  <div className="flip-card-front h-full">
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col cursor-pointer">
                      <div className="p-4 sm:p-6 flex-1 flex flex-col">
                        ...
                        <p className="text-gray-600 mb-3 text-xs sm:text-sm leading-relaxed flex-1">
                          {agent.oneLiner}
                        </p>
                        
                        <div className="text-center mb-3">
                          <p className="text-xs text-green-600 font-semibold">Click to flip</p>
                        </div>
                          ...
                          <div className="bg-gray-50 rounded-lg p-3">
                            <div className="space-y-2">
                              <div className="flex items-start">
                                <span className="text-3xl font-bold text-green-600 mr-2">{agent.stats.value}</span>
                                <span className="text-xs text-gray-600 uppercase tracking-wide font-medium pt-1">
                                  {agent.stats.label}
                                </span>
                              </div>
